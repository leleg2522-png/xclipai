...
const FAKE_PRICES = [30000, 65000, 100000, 350000];
...
function renderAdsStudioPage() {
  ...
  html += '<option value="x3:nano-banana-pro"' + (adsImgModel === 'x3:nano-banana-pro' ? ' selected' : '') + '>🖼️ X Image 3 — Nano Banana Pro</option>';
  html += '<option value="x3:nano-banana-2"' + (adsImgModel === 'x3:nano-banana-2' ? ' selected' : '') + '>🖼️ X Image 3 — Nano Banana 2</option>';
  html += '<option value="x3:imagen-4"' + (adsImgModel === 'x3:imagen-4' ? ' selected' : '') + '>🖼️ X Image 3 — Imagen 4</option>';
  html += '</optgroup>';
  html += '<optgroup label="X Image 2">';
  html += '<option value="x2:nano-banana-pro"' + (adsImgModel === 'x2:nano-banana-pro' ? ' selected' : '') + '>🖼️ X Image 2 — Nano Banana Pro</option>';
  html += '<option value="x2:nano-banana-pro-flash"' + (adsImgModel === 'x2:nano-banana-pro-flash' ? ' selected' : '') + '>🖼️ X Image 2 — Nano Banana Pro Flash</option>';
  html += '<option value="x2:seedream-v5-lite"' + (adsImgModel === 'x2:seedream-v5-lite' ? ' selected' : '') + '>🖼️ X Image 2 — Seedream V5 Lite</option>';
  html += '<option value="x2:flux"' + (adsImgModel === 'x2:flux' ? ' selected' : '') + '>🖼️ X Image 2 — Flux</option>';
  html += '</optgroup>';
  html += '</select>';
...
function renderAutomationPage() {
  ...
  html += '<optgroup label="X Image 3">';
  html += '<option value="x3:nano-banana-pro"' + (autoImgModel === 'x3:nano-banana-pro' ? ' selected' : '') + '>🖼️ X Image 3 — Nano Banana Pro</option>';
  html += '<option value="x3:nano-banana-2"' + (autoImgModel === 'x3:nano-banana-2' ? ' selected' : '') + '>🖼️ X Image 3 — Nano Banana 2</option>';
  html += '<option value="x3:imagen-4"' + (autoImgModel === 'x3:imagen-4' ? ' selected' : '') + '>🖼️ X Image 3 — Imagen 4</option>';
  html += '</optgroup>';
  html += '<optgroup label="X Image 2">';
  html += '<option value="x2:nano-banana-pro"' + (autoImgModel === 'x2:nano-banana-pro' ? ' selected' : '') + '>🖼️ X Image 2 — Nano Banana Pro</option>';
  html += '<option value="x2:nano-banana-pro-flash"' + (autoImgModel === 'x2:nano-banana-pro-flash' ? ' selected' : '') + '>🖼️ X Image 2 — Nano Banana Pro Flash</option>';
  html += '<option value="x2:seedream-v5-lite"' + (autoImgModel === 'x2:seedream-v5-lite' ? ' selected' : '') + '>🖼️ X Image 2 — Seedream V5 Lite</option>';
  html += '<option value="x2:flux"' + (autoImgModel === 'x2:flux' ? ' selected' : '') + '>🖼️ X Image 2 — Flux</option>';
  html += '</optgroup>';
  html += '</select>';
    ...
    try {
      ...
      if (!response.ok) {
        ...
        if (response.status === 500 || response.status === 502 || response.status === 503 || response.status === 504) {
          ...
          task.statusText = 'Server sedang sibuk, mencoba lagi...';
          updateMotionTaskUI(taskId);
          if (task._serverErrorCount >= 15) {
            task.status = 'failed';
            task.error = 'Server tidak merespon setelah beberapa kali percobaan';
            stopPolling();
            render(true);
            return;
          }
