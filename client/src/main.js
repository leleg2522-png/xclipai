...
function renderAdsStudioPage() {
  ...
  html += '<option value="x3:nano-banana-pro"' + (adsImgModel === 'x3:nano-banana-pro' ? ' selected' : '') + '>Nano Banana Pro</option>';
  html += '<option value="x3:nano-banana-2"' + (adsImgModel === 'x3:nano-banana-2' ? ' selected' : '') + '>Nano Banana 2</option>';
  html += '<option value="x3:imagen-4"' + (adsImgModel === 'x3:imagen-4' ? ' selected' : '') + '>Imagen 4</option>';
  html += '</optgroup>';
  html += '<optgroup label="X Image 2">';
  html += '<option value="x2:nano-banana-pro"' + (adsImgModel === 'x2:nano-banana-pro' ? ' selected' : '') + '>Nano Banana Pro</option>';
  html += '<option value="x2:nano-banana-pro-flash"' + (adsImgModel === 'x2:nano-banana-pro-flash' ? ' selected' : '') + '>Nano Banana Pro Flash</option>';
  html += '<option value="x2:seedream-v5-lite"' + (adsImgModel === 'x2:seedream-v5-lite' ? ' selected' : '') + '>Seedream V5 Lite</option>';
  html += '<option value="x2:flux"' + (adsImgModel === 'x2:flux' ? ' selected' : '') + '>Flux</option>';
  html += '</optgroup>';
  html += '</select>';
...
function renderAutomationPage() {
  ...
  html += '<optgroup label="X Image 3">';
  html += '<option value="x3:nano-banana-pro"' + (autoImgModel === 'x3:nano-banana-pro' ? ' selected' : '') + '>Nano Banana Pro</option>';
  html += '<option value="x3:nano-banana-2"' + (autoImgModel === 'x3:nano-banana-2' ? ' selected' : '') + '>Nano Banana 2</option>';
  html += '<option value="x3:imagen-4"' + (autoImgModel === 'x3:imagen-4' ? ' selected' : '') + '>Imagen 4</option>';
  html += '</optgroup>';
  html += '<optgroup label="X Image 2">';
  html += '<option value="x2:nano-banana-pro"' + (autoImgModel === 'x2:nano-banana-pro' ? ' selected' : '') + '>Nano Banana Pro</option>';
  html += '<option value="x2:nano-banana-pro-flash"' + (autoImgModel === 'x2:nano-banana-pro-flash' ? ' selected' : '') + '>Nano Banana Pro Flash</option>';
  html += '<option value="x2:seedream-v5-lite"' + (autoImgModel === 'x2:seedream-v5-lite' ? ' selected' : '') + '>Seedream V5 Lite</option>';
  html += '<option value="x2:flux"' + (autoImgModel === 'x2:flux' ? ' selected' : '') + '>Flux</option>';
  html += '</optgroup>';
  html += '</select>';
